...
| <a name="input_nodes"></a> [nodes](#input\_nodes) | n/a | <pre>list(object({<br/>    node_group_name   = string<br/>    instance_types = list(string)<br/>    auto_scale_options = list(object({<br/>      min = number<br/>      max = number<br/>      desired = number<br/>    }))<br/>  }))</pre> | n/a | yes |
