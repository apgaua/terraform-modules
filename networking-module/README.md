...
| <a name="input_default_tags"></a> [default\_tags](#input\_default\_tags) | Default tags to be set in resources | `list(map(string))` | <pre>[<br/>  {<br/>    "contato": "",<br/>    "dia": "",<br/>    "repo": ""<br/>  }<br/>]</pre> | no |
